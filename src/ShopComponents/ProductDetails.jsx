        ...
        <div>
            ...
            <button
              ...
              ${
                liked
                  ...
                  : "border-zinc-300 dark:border-zinc-700 hover:border-lime-400"
              }
              `}
            >
          ...
          >
            <div className="flex justify-between gap-4">
              <span className="text-zinc-500 dark:text-gray-400">Brand</span>

              <span className="text-right">{product.brand}</span>
            </div>

            <div className="flex justify-between gap-4">
              <span className="text-zinc-500 dark:text-gray-400">Category</span>
